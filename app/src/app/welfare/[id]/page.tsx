        ...
        <div className="w-full flex flex-col min-h-screen" style={{backgroundColor: "#FFFDF7"}}>
            ...
            <div className="flex-1 p-5">
                ...
                <p className="text-sm text-gray-600">
                    URL: <a href={welfare.sourceUrl} target="_blank" rel="noopener noreferrer"
                            className="text-blue-600 hover:underline">{welfare.sourceUrl}</a>
                </p>
            </div>
            ...
            <div className="p-5 border-t flex items-center justify-around" style={{borderColor: "#D4A574"}}>
                ...
                >
                    {isLiked ? <FavoriteIcon style={{color: '#EF4444', fontSize: '24px'}}/> :
                ...
                >
                    {isScraped ? <BookmarkIcon style={{color: '#3B82F6', fontSize: '24px'}}/> :
                        <BookmarkBorderOutlinedIcon style={{fontSize: '24px'}}/>}
